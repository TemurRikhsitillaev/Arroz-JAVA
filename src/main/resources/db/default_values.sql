...
# COURTS
INSERT INTO `arroz`.`courts` (`price`, `surface`, `type`, `phone-number`, `complexID`) VALUES
 ('120000', TRUE, 'outdoor', '+998997802949', 1),
 ('100000', FALSE, 'indoor', '+998997280878', 2);


# BOOKING
INSERT INTO `arroz`.`booking` (`usernameID`, `complexID`,`courtID`,`date`,`time`) VALUES
 (1, 2, 1, '12-12-22', '12:00'),
 (2, 3, 1, '13-12-22', '11:00');
